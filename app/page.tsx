...
const quickActions = [
  ...
  {
    label: "Location",
    href: "https://maps.app.goo.gl/SXaeLrSU9Lx47YPH6",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          <div className="max-w-2xl">
            ...
            <div className="inline-flex items-center gap-2 bg-white/95 backdrop-blur-sm px-6 py-3 rounded-full mb-8 shadow-lg">
              ...
              <span className="text-gray-900 font-semibold text-sm tracking-wide">OPEN 24/7</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="tel:+66962362449" className="group relative bg-white hover:bg-gray-50 text-gray-900 px-8 py-4 rounded-2xl transition-all font-semibold text-lg shadow-xl hover:shadow-2xl flex items-center justify-center gap-3 overflow-hidden">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">The clinic is open every day from 9:00 AM to 12:00 AM (Midnight).</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white/90">58/1, Choeng Thale Subdistrict</p>
                  <p className="text-white/90">Thalang District, Phuket 83100</p>
                  <a href="https://maps.app.goo.gl/SXaeLrSU9Lx47YPH6" target="_blank" rel="noopener noreferrer" className="text-cyan-300 hover:text-cyan-200 hover:underline text-sm">View on Google Maps →</a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <a href="tel:+66962362449" className="text-white/90 hover:text-white">096-236-2449</a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-white/90">9:00 AM - 10:00 PM</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-white/90">@pmcphuket</p>
                </div>
              </div>
            </div>
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a href="https://line.me/R/ti/p/@pmcphuket" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-green-500 text-white py-3 rounded-xl hover:bg-green-600 transition font-medium text-sm">
                  ...
                  <a href="https://wa.me/66962362449" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-green-600 text-white py-3 rounded-xl hover:bg-green-700 transition font-medium text-sm">
                    <svg className="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                    </svg>
                    WhatsApp
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><a href="tel:+66962362449" className="hover:text-white transition">096-236-2449</a></li>
                <li><a href="mailto:team@phuketmedicalclinic.com" className="hover:text-white transition">team@phuketmedicalclinic.com</a></li>
                <li>Line: <a href="https://line.me/R/ti/p/@pmcphuket" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">@pmcphuket</a></li>
                <li><a href="https://wa.me/66962362449" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">WhatsApp</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2024 Phuket Medical Clinic Laguna. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
